...
<body>
    ...
    <h1 class="text-center p-3">Tambah Jurusan</h1>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
    
    <form class="form mb-3" action="{{ action([App\Http\Controllers\JurusanController::class, 'store']) }}" method="post">
        @csrf
        <table>
          <tr>
          ...
          <tr>
            <td>Kode Jurusan</td><td>:</td><td><input type="text" name="kode_jurusan"></td>
          </tr>
          <tr>
            <td>
