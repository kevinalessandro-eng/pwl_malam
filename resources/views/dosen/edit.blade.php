...
<body>
    ...
    <h1 class="text-center p-3">Ubah Data Dosen</h1>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
    
    <form class="form mb-3" action="{{ action([App\Http\Controllers\DosenController::class, 'update'], [$dosen->id]) }}" method="post">
        @csrf
        ...
        <table>
            ...
            <tr>
            <td>Nomor Induk Pegawai</td><td>:</td><td><input type="text" name="NIP" value="{{$dosen->NIP}}"></td>
            </tr>
            <tr>
            <td>Nomor Induk Dosen Nasional</td><td>:</td><td><input type="text" name="NIDN" value="{{$dosen->NIDN}}"></td>
            </tr>
            <tr>
            <td>Pendidikan Terakhir</td><td>:</td><td><input type="text" name="pendidikan_terakhir" value="{{$dosen->pendidikan_terakhir}}"></td>
            </tr>
            <tr>
            <td>Jurusan ID</td><td>:</td><td><input type="text" name="jurusan_id" value="{{$dosen->jurusan_id}}"></td>
            </tr>
            <tr>
            <td>Tempat Lahir</td><td>:</td><td><input type="text" name="tempat_lahir" value="{{$dosen->tempat_lahir}}"></td>
            </tr>
            <tr>
            <td>Tanggal Lahir</td><td>:</td><td><input type="text" name="tanggal_lahir" value="{{$dosen->tanggal_lahir}}"></td>
            </tr>
            <tr>
            <td>Alamat</td><td>:</td><td><textarea name="alamat">{{$dosen->alamat}}</textarea></td>
            </tr>
            <tr>
            <td>
