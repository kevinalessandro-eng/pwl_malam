...
<body>
    ...
    <h1 class="text-center p-3">Table Mata Kuliah</h1>
    ...
    <table class="table table-dark table-hover" class="table table-hover" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$mk->created_at}}</td>
                <td>
                    <a href="{{ action([App\Http\Controllers\MataKuliahController::class, 'edit'], [$mk->id]) }}">
                    <input type="button" class="btn btn-primary btn-lg" value="Edit">
                    </a>
                    <form class="form" action="{{ action([App\Http\Controllers\MataKuliahController::class, 'destroy'], [$mk->id]) }}" method="post">
                    @csrf
