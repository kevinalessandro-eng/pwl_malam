...
<body>
    ...
    <h1 class="text-center p-3">Tambah Mata Kuliah</h1>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
    
    <form class="form mb-3" action="{{ action([App\Http\Controllers\MataKuliahController::class, 'store']) }}" method="post">
        @csrf
        <table>
        <tr>
        ...
        <tr>
          <td>Kode Mata Kuliah</td><td>:</td><td><input type="text" name="kode_mk"></td>
        </tr>
        <tr>
          <td>Nama Mata Kuliah</td><td>:</td><td><input type="text" name="nama_mk"></td>
        </tr>
        <tr>
          <td>SKS</td><td>:</td><td><input type="text" name="sks"></td>
        </tr>
        <tr>
          <td>Dosen ID</td><td>:</td><td><input type="text" name="dosen_id"></td>
        </tr>
        <tr>
          <td>
